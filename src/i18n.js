...
export const I18N = {
  'zh-CN': {
    ...
    'preview.cap': '封面、演员、番号与厂商井然归档。点开封面，即可播放。',
    'cover.preview': '封面预览',
    'cover.close': '关闭',
    'cover.prev': '上一张',
    'cover.next': '下一张',
    ...
    'term.quit': '退出',
    'ledger.full': '进入交互菜单，一键完成全量整理。',
    'ledger.rebuild': '重新扫描并生成片库页面。',
    'ledger.dryrun': '预览整理结果，不改动文件。',
    'ledger.quiet': '无需交互，适合自动与计划任务。',
  ...
  'zh-TW': {
    ...
    'preview.cap': '封面、演員、番號與廠商井然歸檔。點開封面，即可播放。',
    'cover.preview': '封面預覽',
    'cover.close': '關閉',
    'cover.prev': '上一張',
    'cover.next': '下一張',
    ...
    'term.quit': '退出',
    'ledger.full': '進入互動選單，一鍵完成全量整理。',
    'ledger.rebuild': '重新掃描並生成片庫頁面。',
    'ledger.dryrun': '預覽整理結果，不改動檔案。',
    'ledger.quiet': '無需互動，適合自動與排程任務。',
  ...
  en: {
    ...
    'preview.cap': 'Covers, performers, catalog numbers, and studios — all in order. Click a cover to play.',
    ...
    'term.quit': 'Quit',
    'ledger.full': 'Open the interactive menu and run the full pass in one step.',
    'ledger.rebuild': 'Rescan and regenerate the library page.',
    'ledger.dryrun': 'Preview the result without changing any files.',
    'ledger.quiet': 'Run without prompts — ideal for automation and scheduled tasks.',
