...
export const I18N = {
  'zh-CN': {
    ...
    'meta.desc': 'KURAYA 蔵屋 —— JAV 影片刮削与编目工具：把散落的 JAV 影片文件整理成带封面与元数据的有序收藏，并生成离线可读的片库页面。macOS / Windows / Linux 一行命令安装，MIT 许可。',
    'og.desc': '将散落的 JAV 影片文件整理成带封面与元数据的有序收藏，生成离线可读的片库页面。本地优先，MIT 许可。',
    skip: '跳到正文',
    'nav.preview': '片库',
    'nav.cli': '命令',
    'nav.install': '安装',
    'nav.aria': '章节导航',
    'lang.aria': '切换语言',
    'hero.lead': '将散落的 JAV 影片，整理成一座带封面与元数据的片库，<b>离线也能从容欣赏</b>。',
    'install.aria': '选择安装方式',
    'inst.tab.zip': '解压即用',
    copy: '复制',
    copied: '已复制',
    ...
    'legal.declare': '本工具仅整理用户<b>已合法持有</b>的本地 JAV 影片，不提供、不索引、不分发任何内容。',
  ...
  'zh-TW': {
    ...
    'meta.desc': 'KURAYA 蔵屋 —— JAV 影片刮削與編目工具：把散落的 JAV 影片檔案整理成帶封面與中繼資料的有序收藏，並生成離線可讀的片庫頁面。macOS / Windows / Linux 一行指令安裝，MIT 許可。',
    'og.desc': '將散落的 JAV 影片檔案整理成帶封面與中繼資料的有序收藏，生成離線可讀的片庫頁面。本地優先，MIT 許可。',
    skip: '跳到正文',
    'nav.preview': '片庫',
    'nav.cli': '命令',
    'nav.install': '安裝',
    'nav.aria': '章節導航',
    'lang.aria': '切換語言',
    'hero.lead': '將散落的 JAV 影片，整理成一座帶封面與中繼資料的片庫，<b>離線也能從容欣賞</b>。',
    'install.aria': '選擇安裝方式',
    'inst.tab.zip': '解壓即用',
    copy: '複製',
    copied: '已複製',
    ...
    'legal.declare': '本工具僅整理使用者<b>已合法持有</b>的本地 JAV 影片，不提供、不索引、不分發任何內容。',
  ...
  en: {
    ...
    'meta.desc': 'KURAYA 蔵屋 — JAV movie scraper & cataloger: organize scattered JAV movie files into an ordered collection with covers and metadata, and generate an offline-readable library page. One-line install on macOS / Windows / Linux. MIT licensed.',
    'og.desc': 'Turn scattered JAV movie files into an ordered collection with covers and metadata, generating an offline-readable library page. Local-first, MIT licensed.',
    ...
    'hero.lead': 'Turn scattered JAV movies into a library of covers and metadata — <b>enjoy it offline</b>.',
    ...
    'legal.declare': 'This tool only organizes JAV movies you <b>legally own</b>. It does not provide, index, or distribute any content.',
